...
import com.menuz.Utils.FileUtils;
import com.menuz.Utils.ImageCompressor;
import com.menuz.Utils.MyToast;
import com.menuz.Utils.Progress;
import com.menuz.application.MenuZ;
import com.menuz.application.VolleyRequest.AppHelper;
import com.menuz.application.VolleyRequest.VolleyMultipartRequest;
import com.menuz.application.VolleyRequest.VolleySingleton;
...
import static com.menuz.application.MenuZ.IS_DEBUG_MODE;
...
public class HttpTask {
    ...
    public static class Builder {
        ...
        //private static String BASE_URL = API.BASE_URL_PORT1; //"http://koobi.co.uk/api/";
        //Required
        private String api;
        private Context context;
        private HttpResponceListner.Listener listener;
       ...
       /* public Builder setBaseURL(String baseURL){
        ...
        public Builder setAuthToken(String authToken,String pass){
    ...
    public HttpTask(Builder builder){
        ...
        builder.api="http://"+PORTNUMBER+":"+IP+"/datasnap/rest/tservermethods1/"+builder.api;
       /* if (PORTNUMBER.equals("82.81.11.210")&&IP.equals("12986")){
            builder.api=API.BASE_URL_PORT1+builder.api;
        }else {
           // builder.api=API.BASE_URL_PORT2+builder.api;
        }*/
        ...
        if(TextUtils.isEmpty(this.authToken))
            this.authToken = MenuZ.getInstance().getSessionManager().getAuthToken();
    ...
    public void execute(String TAG){
        ...
        MenuZ.getInstance().addToRequestQueue(request, TAG);
    }
