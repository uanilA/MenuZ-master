...
import com.menuz.ui.Payment.model.PaymentModel;
 ...
 *
 * @Modified Anil Upadhyay
 * @version 1.0, 27 Feb 2019
 */
public class SwipePaymentActivity extends PreferenceActivity {
    ...
    private EditText edCibusCardno;
    private EditText edAmount;
    private ProgressBar progress;
    private String cardId = "";
    private String cardNumber = "";
    private String expiryDate = "";
    private PayMethodsModel payMethodsModel = new PayMethodsModel();
    ...
    private String cibus_restaurent_id = "";
    private String cibus_post_id = "";
    ...
    private class OnNewMasterKeyPreferenceChangeListener implements
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (toByteArray(newMasterKeyString, newMasterKey) != 16) {
                ...
                // showMessageDialog(R.string.error, R.string.message_new_master_key_error_length);
    ...
    private class OnMasterKeyPreferenceChangeListener implements
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (toByteArray(masterKeyString, masterKey) != 16) {
                ...
                //  showMessageDialog(R.string.error, R.string.message_master_key_error_length);
    ...
    private class OnAesKeyPreferenceChangeListener implements
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (toByteArray(aesKeyString, aesKey) != 16) {
                ...
                // showMessageDialog(R.string.error, R.string.message_aes_key_error_length);
    ...
    private class OnIksnPreferenceChangeListener implements
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (toByteArray(iksnString, iksn) != 10) {
                ...
                //  showMessageDialog(R.string.error, R.string.message_iksn_error_length);
    ...
    private class OnIpekPreferenceChangeListener implements
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (toByteArray(ipekString, ipek) != 16) {
                ...
                //  showMessageDialog(R.string.error, R.string.message_ipek_error_length);
    ...
    private class OnPiccRfConfigPreferenceChangeListener implements
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (toByteArray(piccRfConfigString, piccRfConfig) != 19) {
                ...
                // showMessageDialog(R.string.error, R.string.message_picc_rf_config_error_length);
        ...
        private void showAesTrackData(AesTrackData trackData) {
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        // showMessageDialog(R.string.error, R.string.message_track_data_error_decrypted);
                    }
                });
            ...
            if (!mReader.verifyData(decryptedTrackData)) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        //  showMessageDialog(R.string.error, R.string.message_track_data_error_checksum);
                    }
                });
        ...
        private void showDukptTrackData(DukptTrackData trackData) {
            ...
            if (!DukptReceiver.compareKeySerialNumber(mIksn,
                ...
                runOnUiThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        //  showMessageDialog(R.string.error, R.string.message_track_data_error_ksn);
                    }
                });
            ...
            if (ec != ec2) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        // showMessageDialog(R.string.error, R.string.message_track_data_error_ec);
                    }
                });
        ...
        private void showTrackData() {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    System.out.println("^^^^^^^^^^^^^^^^^^^^^^^^^^" + mTrack1Data.getTrack1String() + "\n" +
                            mTrack1MaskedData.getTrack1String());
                    ...
                    mTrack2StringPreference.
                            setSummary(concatString(
                                    mTrack2Data.getTrack2String(),
                                    mTrack2MaskedData.getTrack2String()));


                    System.out.println("********************" + mTrack2Data.getTrack2String());
                    ...
                    try {
                        if (s != null) {
                            ...
                            cardId = s.replaceFirst(".$", "");
                            edCibusCardno.setText(cardId);
                            cardNumber = mTrack2Data.getPrimaryAccountNumber();
    ...
    private class OnTrackDataOptionAvailableListener implements
        ...
        @Override
        public void onTrackDataOptionAvailable(AudioJackReader reader, int option) {
            synchronized (mResponseEvent) {
    ...
    private Preference mTrack2StringPreference;
    ...
    private SubActivityAudioJackPlugin _audioJackPluginChecker;
    ...
    private class OnDataAvailableListener implements Acr31.OnReaderDataAvailableListener {
        ...
        public void UpdateUI(Acr31 acr31, Acr31.AvailableData availableData) {
            Log.i("Explore Magnetic Card", "Data was Available");
            switch (availableData) {
                case RAW_DATA:
                    //  ExploreMagneticCard.this.tvDataReceived.setText(acr31.getRawData());
                    return;
                case TRACT_DATA:
                    //   ExploreMagneticCard.this.tvSwipeCount.setText(String.valueOf(acr31.getIswipeCount()));
                    //   ExploreMagneticCard.this.tvt1Jis2Data.setText(acr31.getT1Jis2Data());
                    //    ExploreMagneticCard.this.tvt1CardNumber.setText(acr31.getT1CardNumber());
                    //   ExploreMagneticCard.this.tvt1Name.setText(acr31.getT1Name());
                    //   ExploreMagneticCard.this.tvt1ExpirationDate.setText(acr31.getT1ExpirationDate());
                    //  ExploreMagneticCard.this.tvt1DiscretionaryData.setText(acr31.getT1DiscretionaryData());
                    //  ExploreMagneticCard.this.tvt2CardNumber.setText(acr31.getT2CardNumber());
                    //  ExploreMagneticCard.this.tvt2ExpirationDate.setText(acr31.getT2ExpirationDate());
                    //   ExploreMagneticCard.this.tvt2ServiceCode.setText(acr31.getT2ServiceCode());
                    //    ExploreMagneticCard.this.tvt2DiscretionaryData.setText(acr31.getT2DiscretionaryData());
                    return;
                case RESET_DONE:
                    //  ExploreMagneticCard.this.ivRefresh.setVisibility(0);
                    //   ExploreMagneticCard.this.pbEM.setVisibility(8);
                    return;
                default:
                    return;
            }
    ...
    private class OnErrorListener implements Acr31.OnReaderErrorListener {
        ...
        public void UpdateUI(String str, String str2) {
            ...
            if (SwipePaymentActivity.this.alertDialog != null && SwipePaymentActivity.this.alertDialog.isShowing()) {
                SwipePaymentActivity.this.alertDialog.dismiss();
            }
            AlertDialog.Builder builder = new AlertDialog.Builder(SwipePaymentActivity.this);
            builder.setMessage(str2).setTitle(str).setPositiveButton(R.string.ok, null).setCancelable(true);
            Log.i("Error", "before create");
            SwipePaymentActivity.this.alertDialog = builder.create();
            Log.i("Error", "after create");
            try {
                Log.i("Error", "before show");
                SwipePaymentActivity.this.alertDialog.show();
                Log.i("Error", "after show");
            } catch (Exception e) {
    ...
    private class OnRefreshClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            SwipePaymentActivity.this._acr31.reset(Acr31.ResetType.EXPLORE_MAGNETIC_CARD);

        }
    }

    private String mainChapterNumber = "", paymentMethodId = "", orderId = "", tableId = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("total_pmt_amt") != null) {
            String payatm = getIntent().getStringExtra("total_pmt_amt");
            orderId = getIntent().getStringExtra("orderId");
            paymentMethodId = getIntent().getStringExtra("paymentMethodId");
            tableId = getIntent().getStringExtra("tableId");
            String newStr = payatm.replace("$", "").replace(",", "");
            mainChapterNumber = newStr.substring(0, newStr.indexOf("."));
        }

        showPopupPayment();
        changeNfcEnabled(mContext, true);
        mAudioManager = (AudioManager) getSystemService(Context.AUDIO_SERVICE);
        mReader = new AudioJackReader(mAudioManager, true);

        _acr31 = new Acr31(this);
        _acr31.setOnReaderDataAvailableListener(new OnDataAvailableListener());
        _acr31.setOnReaderErrorListener(new OnErrorListener());
        _audioJackPluginChecker = new SubActivityAudioJackPlugin(this, _acr31);
        ...
        mTrack2StringPreference = findPreference("track2_primary_string");
        ...
        if (savedInstanceState != null) {
            ...
            mTrack2StringPreference.setSummary(savedInstanceState.
                    getCharSequence("track2_primary_string"));
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putCharSequence("track2_primary_string",
                mTrack2StringPreference.getSummary());
...
*/
    ...
    private void clearData() {
        ...
        mTrack2StringPreference.setSummary("");
    ...
    public void showPopupPayment() {
        final Dialog dialog = new Dialog(SwipePaymentActivity.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setCancelable(false);
        dialog.setContentView(R.layout.swap_cibus_dialog_card);
        progress = dialog.findViewById(R.id.progress);
        LinearLayout llChangesLayout = dialog.findViewById(R.id.llChangesLayout);
        ImageView imgClose = dialog.findViewById(R.id.imgClose);
        TextView tvHeader = dialog.findViewById(R.id.tvHeader);
        Switch cibusSwitchSplit = dialog.findViewById(R.id.cibusSwitchSplit);
        edAmount = dialog.findViewById(R.id.edAmount_cash);
        edAmount.setText(mainChapterNumber);
        edCibusCardno = dialog.findViewById(R.id.edCibusCardno);
        edCibusCardno.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
        ...
        Button Cibus_btnDone = dialog.findViewById(R.id.Cibus_btnDone);
        Button Cibus_cancel = dialog.findViewById(R.id.Cibus_cancel);
        Button Cibus_reset = dialog.findViewById(R.id.Cibus_reset);
        POSHandler.getInstance().connectDevice(this);
        cibusSwitchSplit.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    llChangesLayout.setVisibility(View.VISIBLE);
                } else {
                    llChangesLayout.setVisibility(View.GONE);
                }
            }
        });
        Cibus_reset.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Cibus_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        ...
        Cibus_btnDone.setOnClickListener(v -> {

            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
             cibus_restaurent_id = preferences.getString("cibus_restaurent_id", "");
             cibus_post_id = preferences.getString("cibus_post_id", "");

             try {
                 if (TextUtils.isEmpty(edAmount.getText())) {
                     Toast.makeText(this, "Enter amount", Toast.LENGTH_SHORT).show();
                 } else if (TextUtils.isEmpty(edCibusCardno.getText())) {
                     Toast.makeText(this, "Please swipe card", Toast.LENGTH_SHORT).show();
                 } else {
                     parseData(edAmount.getText().toString());
                 }
    ...
    public void parseData(String grandTotal) {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                OrderJsonModel.OrdersBean.PaymentsBean opPaymentsBean = new OrderJsonModel.OrdersBean.PaymentsBean();

                opPaymentsBean.setPaymentApproved("");
                opPaymentsBean.setPaymentID(paymentMethodId);
                opPaymentsBean.setPaymentIdentification(jObjectType.toString());
                opPaymentsBean.setPaymentPrice(grandTotal);
                opPaymentsBean.setPaymentTerminalID("");
                paymentsBeans.add(opPaymentsBean);
    ...
    private void sendJson(String jsonObject, String txtGrandtotal) {
        if (!ConnectionDetector.isConnected()) {
            new NoConnectionDialog(SwipePaymentActivity.this, (dialog, isConnected) -> {
                if (isConnected) {
                    dialog.dismiss();
        ...
        new HttpTask(new HttpTask.Builder(SwipePaymentActivity.this, "syncclient/0/admin/admin/" + jsonObject, new HttpResponceListner.Listener() {
            @Override
            public void onResponse(String response, String apiName) {
                Log.e("SyncClient", "onResponse: " + response);
                try {
                            ...
                            new Thread(() -> {
                                ...
                                if (payMethodsModels != null)
                                    handler.post(() -> {
                                        ...
                                        payMethodsModel.setPosId(cibus_post_id);
                                        payMethodsModel.setFunction("charge");
                                        payMethodsModel.setCardId(cardId);
                                        payMethodsModel.setRefId("");
                                        payMethodsModel.setPrice(edAmount.getText().toString());
                                        List<PaymentModel> listPaymentModels = new ArrayList<>();
                                        listPaymentModels.add(payMethodsModel);
                                        Gson gson = new Gson();
                                        String jsonString = gson.toJson(payMethodsModel);
                                        try {
                                            JSONObject request = new JSONObject(jsonString);
                                            Log.d("json", "" + request);
                                            String json = request.toString().trim();
    ...
    private void sendJson1(String jsonObject) {
        progress.setVisibility(View.VISIBLE);
        if (!ConnectionDetector.isConnected()) {
            new NoConnectionDialog(SwipePaymentActivity.this, (dialog, isConnected) -> {
                if (isConnected) {
                    dialog.dismiss();
                    sendJson1(jsonObject);
                }
            }).show();
        }
        new HttpTask(new HttpTask.Builder(SwipePaymentActivity.this, "api_sodexo/" + jsonObject, new HttpResponceListner.Listener() {
            @Override
            public void onResponse(String response, String apiName) {
                Log.e("SwipePayment", "onResponse: " + response);
