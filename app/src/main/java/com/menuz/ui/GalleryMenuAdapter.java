...
public class GalleryMenuAdapter extends RecyclerView.Adapter<GalleryMenuAdapter.ViewHolder> {
    ...
    GalleryMenuAdapter(Context mContext,List<GalleryModel.ResultBean.GalleryBean> itemsBeanList, onItemClick onItemClick){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(image).error(R.drawable.img_placeholder).into(holder.ivImg);
